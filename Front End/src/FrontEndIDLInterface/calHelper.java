...
/**
* FrontEndIDLInterface/calHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from FrontEndIDLInterface.idl
* Sunday, December 6, 2015 5:15:56 PM EST
*/

abstract public class calHelper
{
  private static String  _id = "IDL:FrontEndIDLInterface/cal:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[2] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (FrontEndIDLInterface.calHelper.id (), "cal", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    FrontEndIDLInterface.cal value = new FrontEndIDLInterface.cal ();
