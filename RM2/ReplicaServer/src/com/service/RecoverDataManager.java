...
//Anunay update code for loop everywhere
			...
			while (true) {
				...
				if (data.getBankName().equalsIgnoreCase("TD")) {
					...
					if (data.getCustomers() != null) {
						...
						System.out.println("RecoverDataManager.UDPListener(): TD Incrementing counter"+bank1Obj.counter.get()+" "+data);
					} else if (data.getLoans() != null) {
						HashMap<Character, List<Loan>> loanMap = bank1Obj
								.getLoanMap();
												
						loanMap.put(key, data.getLoans());
						for(int i=0;i<data.getLoans().size();i++){
							bank1Obj.loanCounter.incrementAndGet();
						}
						
						System.out.println("RecoverDataManager.UDPListener(): TD Incrementing loanCounter"+bank1Obj.loanCounter.get()+" "+data);
					}
					...
					if (data.getCustomers() != null) {
						...
						System.out.println("RecoverDataManager.UDPListener(): RBC Incrementing counter"+bank2Obj.counter.get()+" "+data);
					} else if (data.getLoans() != null) {
						...
						System.out.println("RecoverDataManager.UDPListener(): RBC Incrementing loanCounter"+bank2Obj.loanCounter.get()+" "+data);
					}
					...
					if (data.getCustomers() != null) {
						...
						System.out.println("RecoverDataManager.UDPListener(): BMO Incrementing counter"+bank3Obj.counter.get()+" "+data);
					} else if (data.getLoans() != null) {
						...
						System.out.println("RecoverDataManager.UDPListener(): BMO Incrementing loanCounter"+bank3Obj.loanCounter.get()+" "+data);
					}
